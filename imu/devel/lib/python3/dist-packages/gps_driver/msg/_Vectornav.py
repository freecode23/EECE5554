...
"""autogenerated by genpy from gps_driver/Vectornav.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,latitude,longitude,altitude,utm_easting,utm_northing,zone,letter,hdop,gngga_read,fix_quality
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.gngga_read = str[start:end].decode('utf-8', 'rosmsg')
      else:
