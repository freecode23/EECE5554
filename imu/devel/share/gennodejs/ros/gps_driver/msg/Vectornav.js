...
class Vectornav {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('gngga_read')) {
        this.gngga_read = initObj.gngga_read
      }
      else {
        this.gngga_read = '';
      }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.gngga_read);
    return length + 58;
  }

  static datatype() {
    // Returns string type for a message object
    return 'gps_driver/Vectornav';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.gngga_read !== undefined) {
      resolved.gngga_read = msg.gngga_read;
    }
    else {
      resolved.gngga_read = ''
    }
