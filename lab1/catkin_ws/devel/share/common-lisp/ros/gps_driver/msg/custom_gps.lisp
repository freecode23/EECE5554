...
(cl:defclass <custom_gps> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass custom_gps (<custom_gps>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <custom_gps>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'custom_gps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gps_driver-msg:<custom_gps> is deprecated: use gps_driver-msg:custom_gps instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <custom_gps>))
...
(cl:defmethod latitude-val ((m <custom_gps>))
...
(cl:defmethod longitude-val ((m <custom_gps>))
...
(cl:defmethod altitude-val ((m <custom_gps>))
...
(cl:defmethod utm_easting-val ((m <custom_gps>))
...
(cl:defmethod utm_northing-val ((m <custom_gps>))
...
(cl:defmethod zone-val ((m <custom_gps>))
...
(cl:defmethod letter-val ((m <custom_gps>))
...
(cl:defmethod hdop-val ((m <custom_gps>))
...
(cl:defmethod gpgga_read-val ((m <custom_gps>))
  ...
  (gpgga_read m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <custom_gps>) ostream)
  "Serializes a message object of type '<custom_gps>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <custom_gps>) istream)
  "Deserializes a message object of type '<custom_gps>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<custom_gps>)))
  "Returns string type for a message object of type '<custom_gps>"
  "gps_driver/custom_gps")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'custom_gps)))
  "Returns string type for a message object of type 'custom_gps"
  "gps_driver/custom_gps")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<custom_gps>)))
  "Returns md5sum for a message object of type '<custom_gps>"
  "c13aa5d5b109c777f94aa4fa3948d681")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'custom_gps)))
  "Returns md5sum for a message object of type 'custom_gps"
  "c13aa5d5b109c777f94aa4fa3948d681")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<custom_gps>)))
  "Returns full string definition for message of type '<custom_gps>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'custom_gps)))
  "Returns full string definition for message of type 'custom_gps"
  (cl:format cl:nil "std_msgs/Header header~%float64 latitude~%float64 longitude~%float64 altitude~%float64 utm_easting~%float64 utm_northing~%uint8 zone~%string letter~%float64 hdop~%string gpgga_read~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <custom_gps>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <custom_gps>))
