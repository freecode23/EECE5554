...
if __name__ == "__main__":
    ...
    assert("standalone_driver.py" not in (os.getcwd()+"/src")), "No standalone_driver.py file found in python folder"
    ...
    launchstr ='screen -S ros_node -dm roslaunch ' + package + ' standalone_driver.launch port:=' + port
    launchstr = f"screen -S ros_node -dm bash -c 'source /opt/ros/noetic/setup.bash; source ./devel/setup.bash; roslaunch {package} standalone_driver.launch port:={port}"

    print("launchstr=", launchstr)
    os.system('screen -S ros_node -dm roslaunch "'+package+'" standalone_driver.launch port:="'+port+'"')


    exit_status = os.system(launchstr)
    if exit_status == 0:
        print("Command executed successfully.")
    else:
        print("Command execution failed.")

    print("Screen Running, your ROS node should start within 5 seconds.")
    ...
    try :
        ...
        if "BREAD" in DATA:
            comment,penalty = "not publishing over topic gps. Either node never initialized or topic name was incorrect\n",20
    ...
    try :
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"header Name in message not created correctly. \n",cumulative_penalty + 1
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"Latitude Name in message not created correctly. \n",cumulative_penalty +0.5
        msg_structure_ok = False
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"Longitude Name in message not created correctly. \n",cumulative_penalty +0.5
        msg_structure_ok = False
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"UTM Easting Name in message not created correctly. \n",cumulative_penalty + 0.5
        msg_structure_ok = False
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"UTM Northing Name in message not created correctly. \n",cumulative_penalty + 0.5
        msg_structure_ok = False
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"Letter Name in message not created correctly. \n",cumulative_penalty + 0.2
        msg_structure_ok = False
    ...
    try:
        ...
        cumulative_comment,cumulative_penalty = cumulative_comment +"Zone Name in message not created correctly. \n",cumulative_penalty + 0.2
        msg_structure_ok = False
    ...
    try:
        if DATA.altitude ==0.0:
            ...
            cumulative_comment,cumulative_penalty = cumulative_comment +"Altitude Parsing incorrect. \n",cumulative_penalty + 0.2
            
    except:
        cumulative_comment,cumulative_penalty = cumulative_comment +"Altitude Name in message not created correctly. \n",cumulative_penalty + 0.2
        msg_structure_ok = False
    ...
    try:
        if DATA.hdop ==1.0:
            ...
            cumulative_comment,cumulative_penalty = cumulative_comment +"HDOP Parsing incorrect. \n",cumulative_penalty + 0.2
            
    except:
        cumulative_comment,cumulative_penalty = cumulative_comment +"HDOP Name in message not created correctly. \n",cumulative_penalty + 0.2
        msg_structure_ok = False


    if msg_structure_ok==False:
        msg_structure_ok = False
        cumulative_comment,cumulative_penalty = cumulative_comment +"ROS message structure is incorrect. \n",cumulative_penalty + 1
