...
class Vectornav {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('vnymr_read')) {
        this.vnymr_read = initObj.vnymr_read
      }
      else {
        this.vnymr_read = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [vnymr_read]
    bufferOffset = _serializer.string(obj.vnymr_read, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [vnymr_read]
    data.vnymr_read = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.vnymr_read);
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.vnymr_read !== undefined) {
      resolved.vnymr_read = msg.vnymr_read;
    }
    else {
      resolved.vnymr_read = ''
    }
